...
public class AudioConverterHeadless {
	...
	public AudioConverterHeadless() {
		...
		try {
			String inDirPath = "/home/marytts/voice-builder/wispr/recordings";
			String outDirPath = "/home/marytts/voice-builder/wispr/wav";
			...
			boolean trimSilences = true;
                        ...
                        new HeadlessConverter(inDirPath, outDirPath, bestOnly, stereoMono, whichChannel, downSample, targetSampleRate, soxPath,
